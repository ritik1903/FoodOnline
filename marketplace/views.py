...
def search(request):
    if not 'address' in request.GET:
        ...
        if latitude and longitude and radius:
            ...
            # locations based search functionality
            vendors = Vendor.objects.filter(Q(id__in=fetch_vendors_by_fooditems) or Q(vendor_name__icontains=keyword, is_approved=True, 
